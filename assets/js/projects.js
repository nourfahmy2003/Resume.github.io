const PROJECTS = [
  {
    ...
    ctas: [
      { type: "live", label: "Live (private)", disabled: true },
      { type: "code", label: "Code (private)", disabled: true },
    ],
  },
  {
    title: "Memory Game",
    ...
    ctas: [{ type: "live", label: "Live Demo", disabled: true }],
  },
  {
    title: "CV Maker",
    location: "NL, Canada",
  ...
  },
  {
    ...
    ctas: [{ type: "video", label: "Video demo available", disabled: true }],
  },
  {
    ...
    ctas: [{ type: "notebooks", label: "Notebooks", disabled: true }],
  },
];
    ...
    <div className="flex flex-col h-full p-6 rounded-2xl bg-zinc-900/70 border border-zinc-800 shadow transition-transform brightness-90 hover:brightness-100 active:brightness-110 hover:-translate-y-1 active:translate-y-0">
      ...
      <div className="mt-auto">
        <div className="mt-5 flex flex-wrap gap-2">
          {ctas.map((cta, i) => {
            if (cta.type === "live" || cta.type === "code") {
              if (cta.href && !cta.disabled) {
                return (
                  <a
                    key={i}
                    className="inline-flex items-center px-4 py-2 rounded-full bg-blue-600 hover:bg-blue-500 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    href={cta.href}
                    target="_blank"
              ...
              return (
                <span
                  key={i}
                  className="inline-flex items-center px-4 py-2 rounded-full bg-zinc-800 text-zinc-300 text-sm"
                  aria-disabled="true"
                >
                  {cta.label}
                </span>
            ...
            if (cta.type === "video") {
              ...
              return (
                <button
                  key={i}
                  type="button"
                  className="inline-flex items-center px-4 py-2 rounded-full bg-blue-600 hover:bg-blue-500 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 video-demo"
            ...
            if (cta.type === "notebooks") {
              if (cta.href && !cta.disabled) {
                return (
                  <a
                    key={i}
                    className="inline-flex items-center px-3 py-1 rounded-full bg-blue-600 hover:bg-blue-500 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                    href={cta.href}
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={cta.label}
              ...
              return (
                <span
                  key={i}
                  className="inline-flex items-center px-3 py-1 rounded-full bg-zinc-800 text-zinc-300 text-sm"
                  aria-disabled="true"
                >
                  {cta.label}
                </span>
